...
<header class="text-gray-600 body-font flex ml-10 mr-10">
    ...
    <nav class="w-full flex flex-wrap items-center justify-between space-x-5 ">
    ...
    <ul class="md:w-full flex justify-end items-end">
      <li class="hidden md:block py-0 px-2">
